...
\begin{proof}
  ...
  % TODO: fix equation
  \[ |x - x_n| = |x - x_{g(n)} + x_{g(n)} - x_n| \le |x - x_{g(n)}| + |x_{g(n)} - x_n| < \frac{\varepsilon}{2} + |x_{g(n)} - x_{n_0} + x_{n_0} - x_n| \le \frac{\varepsilon}{2} + |x_{g(n)} - x_{n_0}| + |x_{n_0} - x_n| < \frac{\varepsilon}{2} + \frac{\varepsilon}{4} + \frac{\varepsilon}{4} = \varepsilon. \]
